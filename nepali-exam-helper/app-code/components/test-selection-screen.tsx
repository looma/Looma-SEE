    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-amber-50 flex items-center justify-center">
        ...
        <div className="text-center relative z-10">
          ...
          <p className="text-xl text-slate-700">Loading practice tests...</p>
          <p className="text-slate-600">अभ्यास परीक्षाहरू लोड गर्दै...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-amber-50 flex items-center justify-center p-4">
        ...
        <Card className="w-full max-w-md shadow-xl relative z-10">
          <CardHeader className="text-center bg-gradient-to-r from-red-500 to-orange-500 text-white">
            ...
            <p className="text-red-100">कुनै परीक्षा उपलब्ध छैन</p>
          </CardHeader>
          <CardContent className="text-center p-8">
            ...
            <p className="text-sm text-slate-600 bg-slate-100 p-3 rounded-lg">
              Add test data using:{" "}
              <code className="bg-slate-200 px-2 py-1 rounded">node scripts/import-all-tests.mjs</code>
            </p>
            {onSwitchUser && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <img src="/looma-logo.png" alt="Looma" className="h-12 w-auto" />
              <div>
                <h1 className="text-3xl font-bold text-slate-800">Choose Your Practice Test</h1>
                <p className="text-lg text-slate-600">आफ्नो अभ्यास परीक्षा छान्नुहोस्</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm text-slate-500">Student ID</p>
                <p className="font-semibold text-slate-800">{studentId}</p>
              </div>
              {onSwitchUser && (
                <Button
                  onClick={onSwitchUser}
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  {subject === "science" && "विज्ञान परीक्षाहरू"}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {subjectTests.map((test) => {
                ...
                return (
                  ...
                  >
                    <CardHeader
                      className={`bg-gradient-to-r ${getSubjectColor(test.subject || "")} text-white relative overflow-hidden`}
                    >
                    ...
                    <CardContent className="p-6 bg-white">
                        ...
                        <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-4">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xs text-emerald-600">पूरा भयो</p>
                            </div>
                            <div className="text-right">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xs text-blue-600">प्रगतिमा छ</p>
                            </div>
                            <div className="text-right">
                              <div className="text-2xl font-bold text-blue-800">{progress.percentage}%</div>
                      ...
                      <Button
                        className={`w-full bg-gradient-to-r ${getSubjectColor(test.subject || "")} hover:shadow-lg text-white font-semibold py-3`}
                        onClick={(e) => {
                          e.stopPropagation()
