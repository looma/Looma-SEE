...
def update_science_citations(directory):
    for filename in os.listdir(directory):
        if filename.startswith("see_2081_science_practice_") and filename.endswith(".json"):
            ...
            try:
                ...
                # Rule: Replace "Citation: Lesson" with "Citation: Unit"
                # This covers "Citation: Lesson 1", "Citation: Lesson 5", etc.
                # Regex handles spaces and digits.
                new_content = re.sub(r'(Citation:\s*)Lesson(\s*\d+)', r'\1Unit\2', content)

                # Rule: Replace "उद्धरण: पाठ" with "उद्धरण: एकाइ"
...
if __name__ == "__main__":
    ...
    update_science_citations(directory)
